    ...
    <div class="container-create">
        <form action="{{ route('settings.roles.update', $role->id) }}" method="POST" class="form-container">
                                                    ...
                                                    @if($menuPermission)
                                                        <div class="checkbox-wrapper">
                                                            <input class="custom-checkbox permission-checkbox"
                                                                ...
                                                                {{ in_array($menuPermission->id, $assignedPermissions) ? 'checked' : '' }}>
                                                    ...
                                                    @if($itemPermission)
                                                        <div class="checkbox-wrapper">
                                                            <input class="custom-checkbox permission-checkbox"
                                                                ...
                                                                data-action="{{ $action->id }}"
                                                                {{ in_array($itemPermission->id, $assignedPermissions) ? 'checked' : '' }}>
            ...
            <div class="button-group">
                ...
                <a href="{{ route('settings.roles.index') }}" class="secondary-button">Batal</a>
            </div>
        </form>
    </div>
